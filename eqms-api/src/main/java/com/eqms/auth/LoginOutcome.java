 ...
 */
public record LoginOutcome(Long userId, Long organizationId, String email, String fullName, LoginStatus status) {

    public static LoginOutcome invalidCredentials() {
        return new LoginOutcome(null, null, null, null, LoginStatus.INVALID_CREDENTIALS);
    }

    public static LoginOutcome locked() {
        return new LoginOutcome(null, null, null, null, LoginStatus.LOCKED);
    }

    public static LoginOutcome invalidCode() {
        return new LoginOutcome(null, null, null, null, LoginStatus.INVALID_CODE);
    }
}
